...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Add Inmate',
        href: inmatesRoutes.create().url,
    },
];

export default function CreateInmate({ genders }: CreatePageProps) {
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>): void => {
        ...
        form.post(inmatesRoutes.store().url);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Add Inmate" />

            <div className="space-y-6 p-4">
                <Heading title="Add Inmate" description="Create a new inmate record." />

                <Card>
                    <CardHeader>
                        <CardTitle>Inmate Profile</CardTitle>
                        <CardDescription>Fill in the inmate details below.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form className="grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
                            ...
                            <div className="flex gap-2 md:col-span-2">
                                ...
                                <Button type="button" variant="outline" asChild>
                                    <Link href={inmatesRoutes.index()}>Cancel</Link>
                                </Button>
                            </div>
                        </form>
                    </CardContent>
